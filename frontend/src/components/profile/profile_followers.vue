<template>
    <div class="profile_followers_general">
        ...
        <div class="followers_users" v-if="followers_users != ''">
            <div class="user" v-for="user in followers_users" :key="user.id">
                <div class="left">
                    <div class="image">
                        <img :src="user.image">
                    </div>
...
export default {
    props: ["visited_user", "visitor_user"],
    ...
    async beforeCreate() {
        let purpose = "followers"
        this.followers_users = await user_follows_request(this.visited_user.user_id, purpose)
        this.followers_users = this.followers_users.response
    },
